...
export const RELEASES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      {
        category: "feature",
        text: "Automated Lead Scoring Engine",
        detail:
          "Configure dynamic scoring rules based on job titles, profile completeness, stages, and sources to calculate real-time scores and lead temperatures (Cold, Warm, Hot).",
      },
      {
        category: "feature",
