...
import { pgSchema, text, timestamp, jsonb, uuid } from "drizzle-orm/pg-core";
...
async function cleanAndCreate() {
  ...
  const usersToCreate = [
    ...
    { email: 'client1@prestigebox.dev', password: 'password123', role: 'client', firstName: 'Test', lastName: 'Client' },
  ];
