...
export default async function PropertyAndCasualtyDetailsPage({ params }: PropertyAndCasualtyDetailsPageProps) {
  ...
  const { propertyAndCasualtyFirm, people: peopleRaw, address: addressRaw } = result;
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 md:px-6">
      <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div className="flex items-center gap-4">
          <FirmLogo
            logoUrl={propertyAndCasualtyFirm.logoUrl}
            name={propertyAndCasualtyFirm.firmName}
            className="h-16 w-16 rounded-md border-2 border-primary/10"
            size="lg"
          />
          <div>
            <h1 className="font-bold text-3xl tracking-tight">{propertyAndCasualtyFirm.firmName}</h1>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <Card className="h-fit border shadow-sm md:col-span-1">
          ...
          <CardContent className="space-y-6">
            ...
            {propertyAndCasualtyFirm.website && (
              <>
                <Separator />
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <a
                      href={
                        propertyAndCasualtyFirm.website.startsWith("http")
                          ? propertyAndCasualtyFirm.website
                          : `https://${propertyAndCasualtyFirm.website}`
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 text-blue-600 text-sm hover:underline"
                    >
                      {propertyAndCasualtyFirm.website.replace(/^https?:\/\//, "")}
                      <ArrowUpRight className="h-3 w-3 opacity-60" />
                    </a>
                  </div>
                </div>
              ...
              <>
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href={`tel:${propertyAndCasualtyFirm.phone}`} className="text-primary text-sm hover:underline">
                      {formatPhoneNumber(propertyAndCasualtyFirm.phone)}
                    </a>
                  </div>
                </div>
              </>
