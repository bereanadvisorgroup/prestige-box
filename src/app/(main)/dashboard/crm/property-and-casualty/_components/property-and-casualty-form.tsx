...
import { createPropertyAndCasualtyFirm, updatePropertyAndCasualtyFirm } from "@/actions/property-and-casualty";
...
interface PropertyAndCasualtyFormProps {
  propertyAndCasualtyFirm?: PropertyAndCasualtyFirm;
}
...
export function PropertyAndCasualtyForm({ propertyAndCasualtyFirm }: PropertyAndCasualtyFormProps) {
  ...
  const form = useForm<PropertyAndCasualtyFirmFormInput, any, PropertyAndCasualtyFirmFormValues>({
    ...
    defaultValues: propertyAndCasualtyFirm
      ? {
          personTitles: propertyAndCasualtyFirm.personTitles || {},
          ...
          logoUrl: propertyAndCasualtyFirm.logoUrl || null,
        }
      : {
          personIds: [],
          personTitles: {},
  ...
  const handleAddPerson = (personId: string) => {
    ...
    if (!current.includes(personId)) {
      ...
      toast.error("This person is already associated with this firm");
    }
  };
  ...
  async function onSubmit(values: PropertyAndCasualtyFirmFormValues) {
    try {
      ...
      if (result.success) {
        ...
        toast.error(result.error || `Failed to ${isEditing ? "update" : "create"} record`);
      }
    } catch (error) {
    ...
    <Card className="mx-auto w-full max-w-3xl shadow-sm">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {propertyAndCasualtyFirm ? "Edit Property And Casualty Firm" : "Add Property And Casualty Firm"}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormItem>
                  <FormControl>
                    <LogoUpload
                      ...
                      entityId={propertyAndCasualtyFirm?.id}
                      entityType="property-and-casualty-firms"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Sentinel Property & Casualty" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 pt-2">
                      <FormLabel>Add Professional to Firm</FormLabel>
                      <PersonSearchSelect
            ...
            <div className="flex justify-end gap-3 border-t pt-6 font-semibold">
              ...
              <Button type="submit" disabled={isLoading} className="font-bold">
                {isLoading ? "Saving..." : propertyAndCasualtyFirm ? "Update Firm" : "Create Firm"}
              </Button>
            </div>
          </form>
        </Form>
