...
import { ArrowUpRight, ExternalLink, GraduationCap, Pencil, Phone, Trash2 } from "lucide-react";
...
import type { Address, LawFirm, Person } from "@/types/crm";

export type EnrichedLawFirm = LawFirm & {
  isLinked?: boolean;
};

export const columns = (onDelete: (lawFirm: LawFirm) => void) => [
  {
