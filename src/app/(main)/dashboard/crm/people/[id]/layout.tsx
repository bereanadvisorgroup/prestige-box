...
export default async function PersonDetailLayout({ children, params }: LayoutProps) {
  ...
  // Fetch associations and tags for badges in header
  const [
    clientsRes,
    lawFirmsRes,
    accountingFirmsRes,
    ...
    <div className="fade-in mx-auto w-full max-w-6xl animate-in space-y-8 px-4 py-8 duration-500 md:px-6">
      ...
      <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="flex items-center gap-2 font-bold text-3xl tracking-tight">
                ...
                <span id="person-header-separator" className="hidden font-normal text-muted-foreground/40">
                  {" "}
                  :{" "}
                </span>
                <span id="person-header-section-name" className="font-normal text-muted-foreground/80" />
              </h1>
            </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div id="person-header-actions" className="flex items-center gap-2" />
        </div>
      </div>
