...
export function RecordKeepersTable({ data }: RecordKeepersTableProps) {
  ...
  const tableColumns = useMemo(() => columns(setRecordKeeperToDelete), []);
  ...
  return (
    <div className="space-y-6">
      ...
      <DeleteRecordKeeperAlert
        ...
        recordKeeperName={recordKeeperToDelete?.firmName || ""}
      />
    </div>
  );
}
