...
export default async function MoneyManagerDetailsPage({ params }: MoneyManagerDetailsPageProps) {
                    ...
                    <div key={person.id} className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-muted-foreground text-xs">Wealth Advisor</p>
                        </div>
                      </div>
