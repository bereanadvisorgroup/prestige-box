...
import { columns, type EnrichedEvent } from "./columns";
import { DeleteEventAlert } from "./delete-event-alert";
...
export function EventsTable({ data }: EventsTableProps) {
  ...
  const [eventToDelete, setEventToDelete] = useState<EnrichedEvent | null>(null);
  const [searchValue, setSearchValue] = useState("");

  const tableColumns = useMemo(() => columns(setEventToDelete), []);
