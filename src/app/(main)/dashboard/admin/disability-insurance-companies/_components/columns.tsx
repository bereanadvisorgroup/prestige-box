...
export type EnrichedDisabilityInsuranceCompany = DisabilityInsuranceCompany & {
  isLinked?: boolean;
};

export const columns = (onDelete: (company: DisabilityInsuranceCompany) => void) => [
  {
    accessorKey: "name",
  ...
  },
  {
    ...
    header: "Website",
    cell: ({ row }: { row: Row<DisabilityInsuranceCompany> }) => {
