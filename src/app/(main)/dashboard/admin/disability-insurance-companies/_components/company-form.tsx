...
export function CompanyForm({ company }: CompanyFormProps) {
  ...
  async function onSubmit(values: DisabilityInsuranceCompany) {
    try {
      ...
      let result;
      if (isEditing) {
        result = await updateDisabilityInsuranceCompany(company.id!, values);
      } else {
        result = await createDisabilityInsuranceCompany(values);
      }

      if (result.success) {
        toast.success(isEditing ? "Disability insurance company updated" : "Disability insurance company created");
        router.push("/dashboard/admin/disability-insurance-companies");
        router.refresh();
      } else {
    ...
    <Card className="mx-auto w-full max-w-2xl shadow-md">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-xl">
          ...
          {company ? "Edit Disability Insurance Company" : "Add Disability Insurance Company"}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-1">
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Mutual of Omaha" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem className="md:col-span-1">
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input className="pl-9" placeholder="mutualofomaha.com" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                ...
                <FormItem className="space-y-4 pt-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 pt-2">
                      <FormLabel>Add Professional to Disability Insurance Company</FormLabel>
                      <PersonSearchSelect
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex gap-2">
                <Input
                  placeholder="e.g. Executive Short Term Disability"
                  value={newPolicyName}
